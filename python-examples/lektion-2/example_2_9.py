...
plt.tight_layout()
plt.savefig('/Users/dr.a.schelle/Desktop/IUBH/DLBDSIDS_D/Lektion_2/Python_Examples/fig_2_9.png') # Save the figure to the correct path. You can find your path with the command 'pwd'.
